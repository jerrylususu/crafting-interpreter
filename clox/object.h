...
// an ObjClosure with `this` bounded to an ObjInstance
typedef struct {
    Obj obj;
    Value receiver; // although receiver can only be ObjInstance, using type Value here to avoid pointer converting
    ObjClosure* method;
} ObjBoundMethod;
