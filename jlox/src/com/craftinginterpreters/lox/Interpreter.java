...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        // still needs to bind "this" to the object the method is accessed from
        // the env "this" is bound is always inside the env "super" is bound
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        // introduce a new closure to capture "super"
